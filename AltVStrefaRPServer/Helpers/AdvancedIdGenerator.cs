...
namespace AltVStrefaRPServer.Helpers
{
    public class AdvancedIdGenerator
    {
        ...
        static AdvancedIdGenerator() => PopulatePrefix();
        private AdvancedIdGenerator() { }

        /// <summary>
        /// Returns a single instance of the <see cref="AdvancedIdGenerator"/>.
        /// </summary>
        public static AdvancedIdGenerator Instance { get; } = new AdvancedIdGenerator();
